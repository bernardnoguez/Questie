...
local myJourneyLocales = {
    ...
    ["No Note was entered. You must enter a note before submitting."] = {
        ...
        ["esMX"] = "No has introducido una nota. Tienes que introducir una nota antes de crearla.",
        ["enUS"] = true,
        ["zhCN"] = "内容不可为空",
        ["zhTW"] = "內容不可為空",
    ...
    ["Create an entry in your journal to remember a specific moment. Simply supply a title and description and Questie will remember it for you!"] = {
        ...
        ["esMX"] = "Crea una nueva entrada en tus notas para recordar un momento especifico. Simplemente proporciona un titulo y una descripción y Questie lo recordará por ti",
        ["enUS"] = true,
